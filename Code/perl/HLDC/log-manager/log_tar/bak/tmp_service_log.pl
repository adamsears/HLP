...
#public variable & function
	...
	my $input_linshi_tar = $input_targz_root_dir."201408/20140827*".",".$input_targz_root_dir."201408/20140828*";
...
#check input file if exist
	...
	my $mem_input_file = $input_targz_dir.",".$input_linshi_tar;
...
#check input file if exist	
	...
	my $jobsum_input_dir = $input_targz_dir.",".$input_linshi_tar;
	$cmd = "hadoop jar $hadoop_streaming_jar "
