...
while(1) {
  ...
  foreach $host(@hosts){
    print "\nssh $host ls $hadoop_log_dir/*.log.2014-$month-$day*\n";
    @lines = `ssh $host 'ls $hadoop_log_dir/*.log.2014-$month-$day*'`;
...
#public variable & function
	...
	my $period_dir = $output_root_dir."day-analysis/".$this_period_day_dir;
...
#check input file if exist
	...
	my $mem_ext_yaxu_1 = "eht_1_mem_ext_yaxu";
	$cmd = "hadoop jar $hadoop_streaming_jar "
			."-files $mem_mapred_file "."-Dmapreduce.job.queuename=eht "."-Ddfs.block.size=67108864 "
...
#==========2============run jhist extract hadoop streaming==============================
	...
	my $jhist_ext_yaxu_2 = "eht_2_jhist_ext_yaxu";
...
#check input file if exist	
	...
	my $jobsum_ext_yaxu_3 = "eht_3_jobsum_ext_yaxu";
...
#check input file if exist
	...
	my $jm_union_yaxu_4 = "eht_4_jhist_mem_union_yaxu";
	$cmd = "hadoop jar $hadoop_streaming_jar "
...
#check input file if exist
	...
	my $tm_process_yaxu_5 = "eht_5_task_ctn_union_yaxu";
	$cmd = "hadoop jar $hadoop_streaming_jar "
...
#==========6============run jhist extract hadoop streaming==============================
	...
	my $jhist_ext_yaxu_6 = "eht_6_jhist_ext_t_yaxu";
...
#check input file if exist
	...
	my $ana_yaxu_7 = "eht_7_analysis_mr_mem_yaxu";
	$cmd = "hadoop jar $hadoop_streaming_jar "
